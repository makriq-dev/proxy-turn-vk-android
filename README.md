...
**Пакет:** `net.qwdtt.client` · **Версия:** 1.2.3
...
**Концепция VPS-bridge** (не реализовано): VPS = участник VK-звонка + `wdtt-server` на одном хосте — [docs/VPS_BRIDGE.md](docs/VPS_BRIDGE.md).
